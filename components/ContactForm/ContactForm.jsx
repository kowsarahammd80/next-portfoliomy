                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:grid-cols-1 my-5 lg:my-10 gap-4'>
                     ...
                     >
                        ...
                        <div className='w-full'>
                         <div className='border contactDiv p-3 flex items-center w-full my-3' data-aos="fade-up"
                       data-aos-anchor-placement="top-bottom"
                       data-aos-offset="100"
                       data-aos-duration="1000">
                       ...
                       data-aos-duration="1000">
                         ...
                         <div className='border contactDiv p-3 flex items-center w-full' data-aos="fade-up"
                       data-aos-anchor-placement="top-bottom"
                       data-aos-offset="100"
                       data-aos-duration="1000">
